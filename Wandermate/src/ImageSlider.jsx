...
import Dharan from './assets/lumbini.jpg';
...
function ImageSlider() {
  ...
  return (
    <>
      <div className='px-28'>
        <img src={images[slideIndex]} alt="Slider" className='object-cover h-96 w-full ' />
        <div className="slider-text flex items-center justify-center pt-10 flex-wrap">
          <div className="w-3/4 h-36 pl-2 pr-2 mb-5 bg-white shadow-2xl overflow-hidden">
            {expanded ? (
